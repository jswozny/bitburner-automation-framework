 ...
 *
 * Run: run factions/neuroflux-donate.js              (dry run - shows plan)
 *      run factions/neuroflux-donate.js --confirm    (execute donations and purchases)
 *      run factions/neuroflux-donate.js --reserve 1b (keep 1 billion in reserve)
 */
import { NS } from "@ns";
